...
public class PersonaDao {
    public boolean registrar (String documento, String telefono, String nombre) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "No se puede registrar a la persona", "Error", JOptionPane.ERROR_MESSAGE);
            miConexion.desconectar();
            return false;
        }
    }
    ...
    public boolean actualizar (String documento, String nombre, String telefono) {
        ...
        try {
            ...
            System.out.println(e.getMessage());
            JOptionPane.showMessageDialog(null, "No se puede actualizar a la persona", "Error", JOptionPane.ERROR_MESSAGE);
            miConexion.desconectar();
            return false;
        }
    }
